...
IL_0021:
	{
		IntPtrU5BU5D_tFD177F8C806A6921AD7150264CCC62FA00CAD832* L_6 = V_3;
		NullCheck(L_6);
		V_2 = (intptr_t*)((uintptr_t)((L_6)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))));
	}
...
IL_002a:
	{
		...
		NullCheck(L_8);
		intptr_t L_9 = ___1_arrayClass;
		intptr_t L_10;
		L_10 = AndroidJNI_ToObjectArray_mE2FC617A376102D3F45FE0BD382B59A0B592F182(L_7, ((int32_t)(((RuntimeArray*)L_8)->max_length)), L_9, NULL);
		V_1 = L_10;
		goto IL_0038;
	}
